...
#[test]
fn test_grey_alpha_mix_fold_basic() {
    ...
    let result = GreyAlpha::<f32>::mix_fold(&colours, &weights);
    assert_eq!(result.grey(), 0.5);
    assert_eq!(result.alpha(), 0.5);
}

#[test]
fn test_grey_alpha_mix_fold_weighted() {
    ...
    let weights = [1.0, 3.0];
    let result = GreyAlpha::<f64>::mix_fold(&colours, &weights);
...
#[test]
fn test_grey_alpha_mix_fold_multiple_values() {
    let colours = [
...
#[test]
fn test_grey_alpha_mix_fold_with_zero_weights() {
    let colours = [
...
fn test_grey_alpha_mix_fold_mismatched_lengths() {
    ...
    GreyAlpha::<f32>::mix_fold(&colours, &weights);
}

#[test]
#[should_panic(expected = "Weights must be non-negative")]
fn test_grey_alpha_mix_fold_negative_weights() {
...
#[test]
fn test_grey_alpha_mix_fold_single_colour() {
...
#[test]
fn test_grey_alpha_mix_fold_very_small_weights() {
