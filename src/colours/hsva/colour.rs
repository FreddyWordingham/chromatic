//! Implements the `Colour` trait for `Hsva`.

use core::num::ParseIntError;
use num_traits::Float;

use crate::{Colour, Hsva, ParseColourError};

impl<T: Float> Colour<T, 4> for Hsva<T> {
    ...
    /// Linear interpolate between two `Hsva` colours.
    ///
    /// # Panics
    ///
    ...
    fn lerp(lhs: &Self, rhs: &Self, t: T) -> Self {
        ...
        // Linear interpolation for saturation, value, and alpha
